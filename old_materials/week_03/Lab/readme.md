...
Start by creating a week3 folder in your lab assignments repo.
...
```css
    body{
        ...
        grid-template-areas: "maparea sidepanel" /* this creates one row with map panel on the left and sidepanel on the right */
    }
...
Navigate to [Google Forms](https://docs.google.com/forms?usp=mkt_forms) and click on "Blank":
...
-Work on your group assignment #3 instead!